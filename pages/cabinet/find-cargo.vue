        ...
        <div class="search-bar-container">
          ...
          <div id="carrying" class="bordered d-flex align-center">
            ...
            <div class="inputs d-flex align-center ml-auto">
              ...
              <m-input
                ...
                @input="($event) => (obj.cargoWeight.gte = $event.target.value)"
              ></m-input>
              <span>до</span>
              <m-input
                :digit="true"
                ...
                @input="($event) => (obj.cargoWeight.lte = $event.target.value)"
              ></m-input>
            </div>
          </div>
          <div id="carVolume" class="bordered d-flex align-center">
            ...
            <div class="inputs d-flex align-center ml-auto">
              ...
              <m-input
                ...
                @input="($event) => (obj.cargoVolume.gte = $event.target.value)"
              ></m-input>
              <span>до</span>
              <m-input
                :digit="true"
                ...
                @input="($event) => (obj.cargoVolume.lte = $event.target.value)"
              ></m-input>
            </div>
          </div>
          <m-select
          ...
          <div class="hidden-options">
            <div class="options">
              ...
              ></m-select>
              <div
                class="role-input d-flex flex-column find-equipment"
...
export default {
  ...
  async asyncData({ app, route, store }) {
    ...
    const cargo = JSON.parse(JSON.stringify(store.getters.cargo));
    if (p !== undefined) {
      if (p[e]) {
        if (p[e][n]) {
          limit = p[e][n].limit;
    ...
    try {
      const b = await app.$claim.get('packages');
      [...packages] = b;
    } catch (e) {
      app.$errorHandle(e);
    }
    ...
    try {
      const b = await app.$claim.get('cargo_names');
      [...cargoNameValues] = b;
    } catch (e) {
      app.$errorHandle(e);
    }
